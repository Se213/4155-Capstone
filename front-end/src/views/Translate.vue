  ...
  <div class="text-center">
    <div v-if="user">
      <div class="card-style">
        <h2><i>Translate</i></h2>
        <p><b>
          Select a input language, output language, and type or record your text to have translated.
          Once translated click the speaker to hear the pronunciation of your translated text.
        </b></p>
      </div>
        <div class="back-card">
          <div class="m-3">
